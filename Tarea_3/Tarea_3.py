...
print('\nDentro de lo posible ocupar en IDLE o la terminal de Ubuntu para\nevitar prolemas con caracteres especiales, gracias.')
print('\n')
sleep(0.5)
print('Bienvenido a:')
print('\n')
...
pregunta_jugar=input('En cualquier momento puede ingresar al menu si quiere salir del\njuego, revisar si su solucion es correcta o mas opciones.\n¿Desea comenzar? (si/no): ')
...
while jugar:
    ...
    if celda=='0':
        ...
        print('\n')
        eleccion_menu=input('ingrese el numero (1, 2, 3, 4, 5 o 6) de la accion a realizar: ')
        ...
        if eleccion_menu=='1':
            ...
            if juego.revisarSolucion_regla1() and juego.revisarSolucion_regla4():
                print('\nSolucion correcta!')
                print('\nSu solucion se ha guardado en el archivo de origen')
                ...
                for i in range(len(juego.tablero)):
                    for j in range(len(juego.tablero)):
                        if [i,j] in juego.celdas_negras:
                            ...
                            archivo_guardar.write(' ')
                    archivo_guardar.write('\n')
                pregunta_jugar=input('¿Desea jugar otra vez? (si/no): ')
                while pregunta_jugar!='si' and pregunta_jugar!='no':
                    pregunta_jugar=input('¿Desea jugar otra vez? (si/no): ')
                if pregunta_jugar=='no':
                    pregunta_jugar=input('¿Seguro que quiere salir del juego? (si/no): ')
